...
- **Pendiente para más alcance**: `instagram_manage_insights` (métricas de IG, añadir en *Permisos y funciones* + regenerar token); publicar en FB (`pages_manage_posts`); en producción los DMs/insights pueden requerir **App Review** (modo desarrollo funciona para el propio dueño).
